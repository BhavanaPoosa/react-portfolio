        ...
        <section className="intro">
          ...
          <div className="intro-text">
            ...
            <p>
              ...
              front-end designs to scalable back-end solutions. I'm also an active learner with a deep interest in AI, Generative AI, and emerging technologies.
            </p>
          </div>
        </section>
          ...
          <ul className="achievement-list">
            <li>
              <span className="achievement-tag">Security Improvements</span>
               <span className="achievement-desc"> Addressed vulnerabilities in third-party libraries, strengthening the application's security and ensuring compliance with industry standards.</span>
            </li>
            <li>
              <span className="achievement-tag">Performance Optimization</span>
              <span className="achievement-desc">  Implemented lazy data loading and stack-fetching strategies, resulting in more efficient data handling and faster load times for users.</span>
            </li>
            <li>
              <span className="achievement-tag">Enhanced Test Coverage and Code Quality</span>
              <span className="achievement-desc">  Improved unit test coverage for core components, ensuring better code reliability and reducing the likelihood of production issues.</span>
            </li>
            <li>
              <span className="achievement-tag">Bug Fixing and User Experience Improvements</span>
              <span className="achievement-desc">  Resolved key user-reported defects, including issues with registration and alert search functionality, leading to a more stable and seamless user experience.</span>
            </li>
            <li>
              <span className="achievement-tag">Continuous Integration and Deployment (CI/CD) Enhancements</span>
              <span className="achievement-desc">  Updated Docker configurations and integrated SonarQube properties, improving the build process and ensuring higher quality code in production.</span>
            </li>
          </ul>
        </div>
      </section>
